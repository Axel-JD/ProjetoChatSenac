...
/* --- INÍCIO DA MUDANÇA: SUGESTÕES RÁPIDAS --- */
.sugestoes {{
    margin-top: 10px;
}}
.sugestoes h4 {{
...
div[data-testid="stHorizontalBlock"] div[data-testid="stButton"] button {{
    ...
    border-radius: 12px;
    /* Força a altura a ser a mesma, mesmo com quebra de linha */
    height: 55px; 
    font-size: 0.85rem;
...
div[data-testid="stHorizontalBlock"] div[data-testid="stButton"] button:hover {{
    background-color: var(--sugBg); /* Manter a cor */
    color: var(--sugTxt); /* Manter a cor */
...
st.markdown("</div>", unsafe_allow_html=True)# app.py — Conecta Senac • Aprendiz
# Versão Final Completa e Otimizada
# ----------------------------------------------------------------------
# Recursos: STT/Voz, Foco Senac, Leitura de Notícias (Trafilatura),
# Filtros de Relevância e Data, UI de Chat Otimizada, Barra de Input Fixa e Estilizada.
